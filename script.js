...
angkadm.addEventListener("change", () => {
  ...
  angkadam.value = (dm / 100).toFixed(2);
  angkam.value = (dm / 10).toFixed(2);
...
let buttonkonversi = document.getElementById("buttonkonversi");

buttonkonversi.addEventListener("click", () => {
  if ((km = "")) {
    km = angkakm.value;
    angkahm.value = (km * 10).toFixed(2);
    angkadam.value = (km * 100).toFixed(2);
